                ...
                if (data.superSecret == Config.superSecret) {
                    ...
                    ShareRedeemCoin.find(updated_data_id).then(result => {
                        ...
                        if (dta) {
                            ...
                            if(parseInt(data.phone)==parseInt(body.phone)){
                                res.status(200).send({
                                    "error": "You Can't use your own phone no. as Redeem Code",
                                    "errorvalue": true
                                });
                            } else {
                                var setbody: any = {}
                                    ...
                                    User.find(updated_data_id).then(result => {
                                        ...
                                        User.update(updated_data_id, updated_data).then(result => {
                                            ...
                                            if (notify.result.nModified == 1) {
                                                ...
                                                User.find(updated_data_id).then(result => {
                                                    var dtx: any = result;
                                                    const addedten: number = dtx.usercoins + 0;
                                                    // 10
